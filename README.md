...
- 🔭 I’m currently working on [FlyingFish](https://github.com/stefanwerfling/flyingfish), [PuppeteerCast](https://github.com/stefanwerfling/puppeteercast), [FigTree](https://github.com/stefanwerfling/figtree), [MWPA](https://github.com/M-E-E-R-e-V/mwpa), [MWPA App](https://github.com/M-E-E-R-e-V/mwpa-app), [Bambooo](https://github.com/stefanwerfling/bambooo), [FindNow](https://www.pegenau.de/on-premise-produkte/), [Findnow Plugin for Thunderbird](https://addons.thunderbird.net/de/thunderbird/addon/findnow/), [Toxotidae](https://github.com/stefanwerfling/toxotidae), [VTS-Editor](https://github.com/stefanwerfling/vtseditor), [NjsFsCrypt](https://github.com/stefanwerfling/njsfscrypt)
...
<h3 align="left">Working with AI:</h3>
I build and maintain large-scale software projects as a solo developer—systems that would typically require full teams.

With professional experience since 2005, I focus on architecture, structure, and long-term maintainability.

AI (e.g. Claude Code) is part of my workflow, but never autonomous. Every generated change is reviewed by me via diffs before integration.

This approach significantly accelerates progress and milestone delivery, while keeping all architectural and technical decisions under my control.

AI serves strictly as an assistant and advisor—its output is continuously challenged, verified, and refined.
